    ...
    <>
      <navbar className="flex rounded-md  mx-6 my-7 bg-[#1F1D36]  justify-between px-12  min-h-max text-white">
        ...
        <ul className="flex items-center  gap-7">
          <li className="font-semibold text-[20px]  flex items-center gap-2 hover:flex-row-reverse">
            <svg
          ...
          <li className=" font-semibold flex gap-2 items-center hover:flex-row-reverse text-[20px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
